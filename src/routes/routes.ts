...
const models: TsoaRoute.Models = {
    "Pick_IRefreshToken.Exclude_keyofIRefreshToken.refreshToken__": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"_id":{"dataType":"string","required":true},"ip":{"dataType":"string","required":true},"userAgent":{"dataType":"string"},"date":{"dataType":"datetime","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Omit_IRefreshToken.refreshToken_": {
        "dataType": "refAlias",
        "type": {"ref":"Pick_IRefreshToken.Exclude_keyofIRefreshToken.refreshToken__","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
};
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/api/me/logins',
            ...
            function MeController_logins(request: any, response: any, next: any) {
            const args = {
            ...
            const promise = controller.logins.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, undefined, next);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.delete('/api/me/revoke-login',
            authenticateMiddleware([{"access_token":[]}]),

            function MeController_revokeLogin(request: any, response: any, next: any) {
            const args = {
                    tokenId: {"in":"body-prop","name":"tokenId","required":true,"dataType":"string"},
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
            };
            ...
            const promise = controller.revokeLogin.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, undefined, next);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/api/me/change-password',
            ...
            function MeController_changePassword(request: any, response: any, next: any) {
            const args = {
                    password: {"in":"body-prop","name":"password","required":true,"dataType":"string"},
                    newPassword: {"in":"body-prop","name":"newPassword","required":true,"dataType":"string"},
                    revokeRefreshTokens: {"in":"body-prop","name":"revokeRefreshTokens","required":true,"dataType":"boolean"},
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
                    userAgent: {"default":"","in":"header","name":"user-agent","dataType":"string"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/api/me/change-email',
            authenticateMiddleware([{"access_token":[]}]),

            function MeController_changeEmail(request: any, response: any, next: any) {
            const args = {
                    password: {"in":"body-prop","name":"password","required":true,"dataType":"string"},
                    email: {"in":"body-prop","name":"email","required":true,"dataType":"string"},
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
                    hostUrl: {"in":"header","name":"host","required":true,"dataType":"string"},
            };
            ...
            const promise = controller.changeEmail.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, undefined, next);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/api/signup',

            function RootController_signup(request: any, response: any, next: any) {
            const args = {
                    email: {"in":"body-prop","name":"email","required":true,"dataType":"string"},
                    password: {"in":"body-prop","name":"password","required":true,"dataType":"string"},
                    hostUrl: {"in":"header","name":"host","required":true,"dataType":"string"},
        ...
        app.post('/api/verify-email',
            ...
            function RootController_verifyEmail(request: any, response: any, next: any) {
            const args = {
                    emailVerificationToken: {"in":"body-prop","name":"emailVerificationToken","required":true,"dataType":"string"},
            };
        ...
        app.post('/api/login',
            ...
            function RootController_login(request: any, response: any, next: any) {
            const args = {
                    email: {"in":"body-prop","name":"email","required":true,"dataType":"string"},
                    password: {"in":"body-prop","name":"password","required":true,"dataType":"string"},
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
        ...
        app.post('/api/token',
            ...
            function RootController_token(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/api/request-password-reset',
            ...
            function RootController_requestPasswordReset(request: any, response: any, next: any) {
            const args = {
                    email: {"in":"body-prop","name":"email","required":true,"dataType":"string"},
                    hostUrl: {"in":"header","name":"host","required":true,"dataType":"string"},
            };
        ...
        app.post('/api/reset-password',
            ...
            const args = {
                    passwordResetToken: {"in":"body-prop","name":"passwordResetToken","required":true,"dataType":"string"},
                    password: {"in":"body-prop","name":"password","required":true,"dataType":"string"},
            };
